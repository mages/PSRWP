...
###	Analysis of Data Set 1<a name="Analysis 1"></a>
...
Figure [*BF reserve estimates for data set 1*](#BF reserve estimates for data set 1) shows the results of applying the analytic formulae from `r citep(bib['AMW10'])` for the stochastic BF while Figure [*Comparison of BF and ODP RMSEP*](#Comparison of BF and ODP RMSEP) compares the RMSEP from both methods.
...
### Analysis of Data Set 2<a name="Analysis 2"></a>
...
[^14]: The library TweedieReserve of the R Chain Ladder opensource package can handle different regression structures. Please refer to `r citep(bib['GS05'])` and `r citep(bib['CGMWZ15'])` for further information.
